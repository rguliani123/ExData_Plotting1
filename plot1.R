# Script Name: plot1.R
# Exploratory Analysis (Project 1): Read power consumption data and plots histogram for two days
# Project: 
...
## Plot Global Ative Power (Killowatts)
hist(hhConSubset$Global_active_power, main="Global Active Power", col="Red",
